...
/*********************************************************************
도서 등록 Form 필수 입력필드 입력여부 checking
*********************************************************************/
...
<!--도서정보입력 FORM 테이블시작//-->
<FORM METHOD="post" action="main.do?action=SAVE" name="bookForm" id="bookForm">
	...
	<Table cellpadding="0" cellspacing="1" border="0" width="650" bgcolor="#EAEAEA" align="center">
	    ...
	    <tr>    
          <td  bgcolor="#FFFFFF" height="35" width="120" valign="middle">  
			<img src="images\star_orange.gif" hspace="7" vspace="3" >도서종류
		  </td>  
          <td bgcolor="#FFFFFF" height="35">&nbsp;&nbsp;  
		...
		<tr>
			<td bgcolor="#FFFFFF" height="35" width="120">
				<img src="images\square_gray.gif" hspace="7" vspace="3">&nbsp;출판국가
			</td>
			<td bgcolor="#FFFFFF" height="35">&nbsp;&nbsp;
	...
	<Table cellpadding="0" cellspacing="1" border="0" width="650" bgcolor="#EAEAEA" align="center">
		<tr>
			<td align="center" height="30" valign="middle">
				<a href="javascript:confirmation()"><img src="images\ok.gif" width="64" height="29" vspace="12" hspace="2" alt="확인"  border="0"  border="0"></a>
				<a href="javascript:formReset()"><img src="images\cancel.gif" width="64" height="29" vspace="12" hspace="2" alt="취소"  border="0" ></a>
			</td>
		</tr>
	</table>
</FORM>
