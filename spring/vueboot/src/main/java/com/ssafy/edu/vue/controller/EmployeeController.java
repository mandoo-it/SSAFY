...
public class EmployeeController {
	...
	@GetMapping(value = "/findEmployeesByManagerId/{manager_id}")
    ...
    @ApiOperation(value = "부서별 직원수와 부서이름", response = List.class)
   	@GetMapping(value = "/findAllDepCounts")
	...
	@GetMapping(value = "/findDepartmentsBydeptid/{dept_id}")
    ...
    @ApiOperation(value = "해당부서의 직원들 정보", response = List.class)
	@GetMapping(value = "/findDepartmentsByname/{name}")
    ...
    @ApiOperation(value = "부서별 정보와 사원", response = List.class)
   	@GetMapping(value = "/findAllDeptEmps")
    ...
    @ApiOperation(value = "부서별 정보와 사원 계층모양", response = List.class)
   	@GetMapping(value = "/findAllDeptEmps2")
