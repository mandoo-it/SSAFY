...
public class BookTest {
	...
	bm.add(new Magazine("2", "Java World", "편집부", "java.com", 7000,"첫걸음",2018,2));
	bm.add(new Novel("3", "twilter", "편집부", "java.com", 7000,"첫걸음","호러"));
	bm.add(new Novel("4", "Java World", "편집부", "java.com", 7000,"첫걸음","로맨스"));
	bm.add(new Magazine("5", "Java World", "편집부", "java", 7000,"첫걸음",2018,2));
	...
	if(bm.findByTitle("twilterdd").length > 0) {
	...
	if(bm.findByPublisher("java").length > 0) {
	...
	if(bm.findByPrice(7000).length > 0) {
